...
const Player = () =>{
    ...
    const {track,seekBar,seekBg,playStatus,pause,play,time,previous,next,seekSong} = useContext(playerContext)
    ...
    return(
        <div className="h-[10%] bg-black flex justify-between items-center text-white px-4">
           ...
           <div className="flex flex-col items-center gap-1 m-auto">
                ...
                {playStatus? 
                <img onClick={pause} className="w-4 cursor-pointer" src={assets.pause_icon} /> : <img onClick={play} className="w-4 cursor-pointer" src={assets.play_icon} />
                }
           ...
           <div className="flex items-center gap-5">
                       ...
                       <div ref={seekBg} onClick={seekSong} className="w-[60vw] max-w-[500px] bg-gray-300 rounded-fill cursor-pointer">
